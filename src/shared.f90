module shared_mod
  ...
  type(coord), dimension(12) :: penta_node             ! coordinates of pentagon 
  type(coord), dimension(12) :: penta_node_std = [ &   ! coordinates of pentagons (unrotated grid)
       Coord ( 0.0,  0.0,  1.0), &
       Coord ( 0.0,  0.0, -1.0), &
  ...
  real(dp)                                       :: c1, c_g, c_p, c_s, c_v, H_rho,  r_adv, r_dif, R_d, wave_speed
