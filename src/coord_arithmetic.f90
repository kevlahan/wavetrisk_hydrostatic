module coord_arithmetic_mod
  ...
  interface operator (/)
     ...
     module procedure coord_divide_cc
  end interface operator (/)
contains
  elemental type(coord) function coord_plus_cc (c1, c2)
    type(coord), intent (in) :: c1, c2

    coord_plus_cc = coord (c1%x+c2%x, c1%y+c2%y, c1%z+c2%z)
  end function coord_plus_cc

  elemental type(coord) function coord_plus_rc (c1, c2)
  ...
  elemental type(coord) function coord_plus_cr (c1, c2)
  ...
  elemental type(coord) function coord_minus_cc (c1, c2)
    type(coord), intent (in) :: c1, c2

    coord_minus_cc = coord (c1%x-c2%x, c1%y-c2%y, c1%z-c2%z)
  end function coord_minus_cc

  elemental type(coord) function coord_minus_rc (c1, c2)
    real(dp),    intent (in) :: c1
    type(coord), intent (in) :: c2
  ...
  elemental type(coord) function coord_minus_cr (c1, c2)
    real(dp),    intent (in) :: c2
    type(coord), intent (in) :: c1
  ...
  elemental real(dp) function coord_times_cc (c1, c2)
    ! Inner product
    implicit none
    type(coord), intent (in) :: c1, c2
  ...
  elemental type(coord) function coord_times_rc (c1, c2)
    implicit none
    real(dp),    intent (in) :: c1
    type(coord), intent (in) :: c2
  ...
  elemental type(coord) function coord_times_cr (c1, c2)
    implicit none
    real(dp),    intent (in) :: c2
    type(coord), intent (in) :: c1
  ...
  elemental type(coord) function coord_divide_cr (c1, c2)
    implicit none
    real(dp),    intent (in) :: c2
    type(coord), intent (in) :: c1
  ...
  elemental type(coord) function coord_divide_cc (c1, c2)
    implicit none
    type(coord), intent (in) :: c1, c2

    coord_divide_cc = coord (c1%x/c2%x, c1%y/c2%y, c1%z/c2%z)
  end function coord_divide_cc
