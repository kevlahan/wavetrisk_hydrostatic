...
contains
  ...
  subroutine remap1_tile (N, var_new, z_new, var_old, z_old)
    ...
    logical, parameter      :: ENHANCE = .true.  ! commented in
  ...
  subroutine remap2PPM_tile (N, var_new, z_new, var_old, z_old)
    ...
    logical, parameter      :: NEUMANN        = .false. ! commented in
  ...
  subroutine remap2W (N, var_new, z_new, var_old, z_old)
    ...
    logical, parameter      :: LIMIT_INTERIOR = .false. ! commented out (setting true could cause oscillations at boundary)
    logical, parameter      :: LIMIT_SLOPES   = .true.  ! commented in
    logical, parameter      :: NEUMANN        = .false. ! commented out
  ...
  subroutine remap4_tile (N, var_new, z_new, var_old, z_old)
    ...
    logical, parameter      :: NEUMANN = .false. ! Neumann option commented out for efficiency
    !
    ! Parabolic WENO reconstruction: The second and third loops below
    !---------- ---- --------------- compute left and right side limits
    ! aL,aR of the field var_old assuming monotonized parabolic distributions
