...
contains
  ...
  subroutine init_RK_mem()
    ...
    do k = 1, zlevels
       do v = S_MASS, S_VELO
          call init_Float_Field(q1(v,k), v)
          call init_Float_Field(q2(v,k), v)
          call init_Float_Field(q3(v,k), v)
          call init_Float_Field(q4(v,k), v)
          call init_Float_Field(dq1(v,k), v)
       end do
    end do
