...
See [WAVETRISK manual](docs/manual.md)  for a full description of the `WAVETRISK` global circulation model, including compilation/running and available test cases.
