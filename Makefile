...
base_$(ARCH).f90 dgesv.f90 dgtsv.f90 domain.f90 init.f90 comm.f90 comm_$(ARCH).f90 utils.f90 equation_of_state.f90 \
wavelet.f90 lnorms.f90 mask.f90 refine_patch.f90 smooth.f90 test_case_module.f90 ops.f90 multi_level.f90 adapt.f90 lin_solve.f90  \
barotropic_2d.f90 time_integr.f90 vert_diffusion.f90 lateral_diffusion.f90 io.f90 remap.f90 main.f90
