...
$(BUILD_DIR)/parallel_block_inverse.o: \
	$(BUILD_DIR)/kind.o \
	$(BUILD_DIR)/shared.o \
	$(BUILD_DIR)/arch.o \
	$(BUILD_DIR)/domain.o \
...
$(BUILD_DIR)/parallel_block_mpi.o: $(BUILD_DIR)/parallel_block_inverse.o $(BUILD_DIR)/parallel_block_velocity.o
